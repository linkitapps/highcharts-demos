			...
			var playAudio = function() {
				...
				if(!isChrome){
					var playAudio = '<audio autoplay  id="playAudio">'
								+'<source src="http://qvdb.pantos.com/sso/exception.mp3">'
								+'</audio>';
				}
				else{
					var playAudio = '<iframe src="http://qvdb.pantos.com/sso/exception.mp3" allow="autoplay" style="display:none" id="playAudio"></iframe>';
				}
