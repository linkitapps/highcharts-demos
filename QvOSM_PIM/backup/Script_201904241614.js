    ...
    Qva.LoadScript(QvOSM_exUrl + "js/d3.v3.min.js", function() {
        Qva.LoadScript(QvOSM_exUrl + "js/ol.js", function() {
            ...
            function fn_aniFlash(feature, number) {
                ...
                clearTimeout(incidentIconAni[number]);
                ...
                listenerKey = QvOSM_PVM_MAP.on('postcompose', animate);
                incidentIconAni[number] = setTimeout(function() { fn_aniFlash(feature, number) }, 10000);
                //console.log('id : ', incidentIconAni[number]);
            }
            ...
            var drawINCIDENT = function() {
                ...
                */
                ...
                if (incidentIconAni.length > 0) {
                    ...
                    for (var AniCnt = 0; AniCnt < incidentIconAni.length; AniCnt++) {
                        fn_addIncidentAniFeature(incidentIconAni[AniCnt], AniCnt);
                    }
                            ...
                            try {
                                ...
                                if (incidentIconAni.length > 0) {
                                    for (var i = 0; i < incidentIconAni.length; i++) {
                                        clearTimeout(incidentIconAni[i]);
                                    }
                                    incidentIconAni = [];
                                }
