	...
	Qva.LoadScript(QvOSM_exUrl+"js/d3.v3.min.js", function(){
		Qva.LoadScript(QvOSM_exUrl+"js/ol.js", function(){
			...
			var drawMAP = function(){
				...
				htmlString += '<div id="tooltip-always"></div>';
			...
			var drawINCIDENT = function(){
				...
				if(incidentData.length>0){
					...
					$.each(incidentData,function($key,incidentObj){
						...
						var vIconFea = new ol.Feature(new ol.geom.Point(point));
						var ttFea = new ol.Feature(new ol.geom.Point(point));
						...
						var tooltip = "";
						var tooltipal = "<div class='tooltip'>";
						...
						ttFeasarray.push(popup);
						//ttFea.set('tooltip', tooltip);
					...
					// 툴팁
					var ttVector = new ol.source.Vector({
						features: ttFeas
					});
					tooltipLayer = new ol.layer.Vector({
						style : function(feature) {
									return feature.get('style');
								},
						source:ttVector
...
*/
			...
			// 툴팁
			var toolOverlay = new ol.Overlay({
				element: document.getElementById("tooltip-always"),
				positioning: 'bottom-left',
				offset: [20,20]
			});

			toolOverlay.setMap(QvOSM_PVM_MAP);
			
			var drawToolTips = function() {
				var htmlContent = "";
				htmlContent += "<div class='tooltip'>";
				console.log(tooltipLayer.getFeatures
				
				tooltipLayer.setZIndex(300);
				QvOSM_PVM_MAP.addLayer(tooltipLayer);
			}
