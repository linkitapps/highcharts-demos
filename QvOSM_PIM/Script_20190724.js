								...
								if($v["except_cnt"]>0 && exceptObj["lngtd"]==$v["lngtd"] && exceptObj["ltitde"]==$v["ltitde"]
									...
									if( (vEXCEPTION_ONOFF=="ON" || vNEWS_EXCEPT_LV1_2=="1") ) {
										switch(exceptObj["level"]){
											case " Lv. 1":
												if("Y" == exceptObj["hotFlag"])
													incidentData[$k]["icon"] = "ELV1_T";
												else if("ELV1_T" != incidentData[$k]["icon"])
											...
											case " Lv. 2":
												...
												else if("ELV2_T" != incidentData[$k]["icon"])
							...
							setTimeout(function(){
								...
								if(!isChrome){
									var playAudio = '<audio autoplay  id="playAudio">'
												+'<source src="http://10.86.225.39/sso/test.mp3">'
												+'</audio>';
								}
								else{
									//console.log(QvOSM_exUrl);
									var playAudio = '<iframe src="http://10.86.225.39/sso/test.mp3" allow="autoplay" style="display:none" id="playAudio"></iframe>';
								}
