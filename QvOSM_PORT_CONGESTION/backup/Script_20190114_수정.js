			...
			Qva.AddExtension(ExName, function() {
				...
				if(!varsRetrieved){
					...
					try {
                        ...
                        if( vEXT_RISK_SCORE.GetVariable(10).text ){
                            try{
								...
								if( '-' != vEXT_RISK_SCORE.GetVariable(10).text && '' != vEXT_RISK_SCORE.GetVariable(10).text && null != vEXT_RISK_SCORE.GetVariable(10).text){
									vNEWS = JSON.parse( vEXT_RISK_SCORE.GetVariable(10).text );
								}else{
									vNEWS = [];
								}
                        ...
                        // // GetVariable(11) : vPORT_NEWS
                        if( vEXT_RISK_SCORE.GetVariable(11).text ){
                            try{
                                // console.log( vEXT_RISK_SCORE.GetVariable(11).text );
                                //vPORT_NEWS = JSON.parse( vEXT_RISK_SCORE.GetVariable(11).text );
								if( '-' != vEXT_RISK_SCORE.GetVariable(11).text && '' != vEXT_RISK_SCORE.GetVariable(11).text && null != vEXT_RISK_SCORE.GetVariable(11).text){
									vPORT_NEWS = JSON.parse( vEXT_RISK_SCORE.GetVariable(11).text );
								}else{
									vPORT_NEWS = [];
								}
