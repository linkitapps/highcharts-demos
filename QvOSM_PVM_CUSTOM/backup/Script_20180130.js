			...
			try {
				...
				if(!this.framecreated){
					...
					*//*<img src="'+QvOSM_PVM_CUSTOM_exUrl+'icon/btn_transit.png" width="89" height="27"/>*/
					if(mb_chk){
						htmlString += '<div id="pointPopup" class="ol-popup mobile"><div class="ol-popup-title"><img class="port-img" src="'+QvOSM_PVM_CUSTOM_exUrl+'icon/marker_port.png"><span class="ol-popup-headtitle-content"></span><span class="ol-popup-title-content"></span></div><a href="#" id="popup-closer" class="ol-popup-closer"></a><div id="popup-content"></div></div><div id="geo-marker"></div>'+
									'<div id="'+uId+'" class="map" style="width:1024px;height:1024px;"></div>'+
								  '</div>';
					}else{
						htmlString += '<div id="pointPopup" class="ol-popup"><div class="ol-popup-title"><img class="port-img" src="'+QvOSM_PVM_CUSTOM_exUrl+'icon/marker_port.png"><span class="ol-popup-headtitle-content"></span><span class="ol-popup-title-content"></span></div><a href="#" id="popup-closer" class="ol-popup-closer"></a><div id="popup-content"></div></div><div id="geo-marker"></div>'+
				...
				var vesselrouteDraw = function(){
					...
					*/
					...
					if(vesselrouteObjLength>0){
						...
						arcCoord = getroutepathCoord(vesselrouteObj[vesselrouteObj.length-1].VESSEL_PAST_ROUTE);
						
						arcCoorddate =(vesselrouteObj[vesselrouteObj.length-1].VESSEL_PAST_DATE).split(",");
						...
						/*for(var arci=0;arci<(vesselrouteObjLength-1);arci++){
							arcCoord.push(vesselrouteObj[arci].XY);
