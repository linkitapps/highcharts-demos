                ...
                if( vTyphoon_Var_Lisr.Data.Rows.length > 0 ){
                    ...
                    if( vTyphoon_Var_Lisr.GetVariable(3).text ){
                        ...
                        try{
                            ...
                            console.log( '3 vSTD_ROUTE_YN : ', vSTD_ROUTE_YN );
                        }catch( e ){
                    ...
                    if( vTyphoon_Var_Lisr.GetVariable(5).text ){
                        console.log( 'vTyphoon_Var_Lisr.GetVariable(5).text 들어옴 태풍데이터 값 가져오기' );
                        try{
                            //typhoon row data;
                            // if(vTYPHOON==null)
                    ...
                    if( vTyphoon_Var_Lisr.GetVariable(7).text ){
                        try{
                            ...
                            // if(vCURR_TYPHOON==null)
                            console.log( vTyphoon_Var_Lisr.GetVariable(7).text );
...
*/
				...
				//	console.log("===========================================================================================");
					...
					if( oldVIEWTYPE != vVIEWTYPE && oldVIEWTYPE != undefined  || IsChkCnt>0){
