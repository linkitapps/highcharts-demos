						...
						if(TYPHOON_ICON_ARR.length>0){
							$.each(TYPHOON_ICON_ARR,function($key,$value){
                                ...
                                if($_VAR["vSEL_TYPHOON"]){
                                    ...
                                    $('#typhoon-descript').css("top", ( window.screen.availHeight - 230 + ( undefined === window.scrollY ? 0 : window.scrollY ) ) + 'px')
                                }else{
...
*/
                    ...
                    if( $_VAR.vSEL_TYPHOON ){
                        ...
                        window.addEventListener('scroll', function(e) {
                            $('#typhoon-descript').css("top", ( window.screen.availHeight - 230 + $(this).scrollTop() ) + 'px')
                        });
                    }
