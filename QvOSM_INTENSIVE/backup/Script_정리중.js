...
const QV_OSM_EX_URL = "/QvAjaxZfc/QvsViewClient.aspx?public=only&name=Extensions/" + EX_NAME + "/";
...
const MAP_TYPE_GROUP = {
    ...
    "satelite": 'https://api.mapbox.com/styles/v1/seungok/ciousf1zl003sdqnfpcpfj19r/tiles/{z}/{x}/{y}?access_token=pk.eyJ1Ijoic2V1bmdvayIsImEiOiJjaW5oN3A4dWYwc2dxdHRtM2pzdDdqbGtvIn0.JLtJmHeZNzC5gg_4Z6ioZg', //layersTn
...
let showVesselPopup = function(currPopup, info) {
    ...
    $("#pointPopup_vessel .ol-popup-title-content").off("click").on("click", function() {
        $("#pointPopup_vessel .popup-closer").trigger("click");
    });
