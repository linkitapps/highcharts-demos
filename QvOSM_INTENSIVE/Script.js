...
var vEXT_INTENSIVE = CQV.GetObject("vEXT_INTENSIVE");
...
let drawPort = function() {
    ...
    let portFeasStyles = {
		...
		'orangeCrclPOL': new ol.style.Style({
            image: new ol.style.Circle({
                radius: 9,
                stroke: new ol.style.Stroke({
                    color: '#fff',
		...
		'orangeCrclPOD': new ol.style.Style({
            image: new ol.style.Circle({
                radius: 9,
                stroke: new ol.style.Stroke({
                    color: '#fff',
    ...
    portDataArr.forEach(function(portData) {
		...
		let circleType = 'blueCrcl';
		if(portData.portFlag=='POL'||portData.portFlag=='POD'){
			circleType = 'orangeCrcl';
		}
		
        portFeas.push(		   
            new ol.Feature({
				text: portData.portFlag,
                ref: 'port',
                portInout: portData.portInout,
                type: circleType + portData.portFlag ,
...
let drawNoti = function() {
    ...
    notiPortDataArr.forEach(function(notiData) {
        ...
        let indx = -1;
		for(var i=0; i<featureDataArr.length; i++) {
			if(JSON.stringify(featureDataArr[i].notiPoint) == JSON.stringify(notiPoint)) {indx = i; break;}	
		}
        if (indx > -1) {
			featureDataArr[indx].text += "\n";
        ...
        style: function(feature) {
            ...
            let style = new ol.style.Style({
                image: new ol.style.Icon({
					...
					anchorXUnits: 'pixels',
					anchorYUnits: 'pixels',
                    src: "data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAACwAAAAsCAMAAAApWqozAAAABGdBTUEAALGPC/xhBQAAACBjSFJN AAB6JgAAgIQAAPoAAACA6AAAdTAAAOpgAAA6mAAAF3CculE8AAACr1BMVEUAAAD////+/v7////+ /v7////////9/f39/v78/v78/f39/f3+/v7+/v7+/v7+/v7+/v7+/v7+///7+/v8/Pz+/v7////7 +/v+/v7+/v76+vrMzMz6+vr+/v79///9/f3////7+/v9/f38/Pz+/v78/Pz9/f3+/v7+/v77+/v+ ///+/v7////9/f39/f38/Pz+///6+vr////9/f36/Pz+/v7+///9/f3////+///////+///+///+ /v7+/v78/Pz////+/v7+/v7+/v7+/v7+/v7r6+v9/v79/f37+/v9///////7+/v9/v7+/v7+/v79 /v79/f3////+///7+/v+/v7+/v709PT8/Pz+/v78/Pz9/f3////6+vr9/v7+/v7+/v7+/v79/f3+ +fn9/v7+///////+/v7+/v7+///+///+///9/f38/v7////////////+/v7+///9/f3+/v78/Pz+ ///+/v7////9/f39/f36+vr+/v7+/v79/f3+/v79/f39/v79/v78/f39/f3+/v7+/v7+/v7+/v7+ /v7//////f3/+Pj/5OT/Rkb/Hh7/b2//9vb/eHj/AAD/BAT/sbH/V1f/oKD/U1P/l5f/+fn/ra3/ RET/Dw//Gxv/ycn//v7/wcH/Pz//AwP/CQn/W1v/3t7/qqr/HBz/MzP/0ND/vLz/Fxf/4OD/7Oz/ Li7/Y2P/k5P/y8v/9fX/QUH/c